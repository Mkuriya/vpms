...
<div class="header">
                ...
                <tr>
                    ...
                    <th>Action</th>
                            ...
                            <tr>
                                ...
                                <td><?= $row->lastname;?></td>
                                <td>
                                    <a href="updateguard.php?id=<?=$row->guardnumber; ?>" id="up">Update</a>
                                    <form >
                                    <button type="button" title="Delete" id="del" onclick="delete_guard(<?php echo $row->guardnumber ?>)">Delete</button>
                                    </form>
                                </td>
                            </tr>
                                    <?php
        ...
        <div class="search">
        <form action="searchguard.php" method="get">
       ...
       function delete_guard(id) {
        if (confirm("Do you want to delete this guard data?")) {
            window.location = "delguard.php?guardnumber=" + id;
        }
